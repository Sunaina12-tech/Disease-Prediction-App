...
kidney_disease_model = pickle.load(open(f'{working_dir}/saved models/kindey.pkl','rb'))
parkinsons_model = pickle.load(open(f'{working_dir}/saved models/parkinsons.pkl', 'rb'))
...
with st.sidebar:
    selected = option_menu("Mulitple Disease Prediction", 
                ['Diabetes Prediction',
                 ...
                 icons=['activity','heart', 'star', 'person'],
                 default_index=0)
